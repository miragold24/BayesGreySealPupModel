// greysealpups_Deads_estTTL.stan
// Full model with explicit mortality
//TTL (leave process) is estimated andTTM (moult process) is fixed at 23 days
...
transformed parameters {
  ...
  // Estimated leave process
  real muLeave = 30.0 + muLeave_raw * 2.5;
  real sdLeave = 1 + sdLeave_raw * 5.0;
...
model {
  ...
  // Priors - leave process (estimated)
